window.onload = () => {
    ...
    if (typeof google !== 'undefined') {
        google.accounts.id.initialize({
            client_id: "81041045325-n7uqt6bk0ld60kr2ie1el9v3regn3k0m.apps.googleusercontent.com",
...
// ✅ Keep handleCredentialResponse in global scope
function handleCredentialResponse(response) {
    fetch("https://brightnal.onrender.com/api/auth/google", {
        method: "POST",
